...
export const SHORT_DECK_RANKS: Rank[] = ['6', '7', '8', '9', '10', 'J', 'Q', 'K', 'A'];

const STANDARD_HAND_RANK_ORDER: HandRank[] = [
...
const SHORT_DECK_HAND_RANK_ORDER: HandRank[] = [
  HandRank.ROYAL_FLUSH, HandRank.STRAIGHT_FLUSH, HandRank.FOUR_OF_A_KIND,
  HandRank.FLUSH, HandRank.FULL_HOUSE, HandRank.STRAIGHT,
  HandRank.THREE_OF_A_KIND, HandRank.TWO_PAIR, HandRank.ONE_PAIR, HandRank.HIGH_CARD,
];

export const VARIANT_RULES: Record<GameVariant, VariantRuleInfo> = {
  [GameVariant.TEXAS_NLHE]: {
    id: GameVariant.TEXAS_NLHE,
    name: '常规德州',
    icon: '🤠',
    ...
    boardCount: 1,
    deckRanks: [...RANKS],
    handRankOrder: STANDARD_HAND_RANK_ORDER,
    isPotLimit: false,
    isFixedLimit: false,
  ...
  [GameVariant.TEXAS_LHE]: {
    ...
    isPotLimit: false,
    isFixedLimit: true,
    specialRules: ['2张底牌，自由组合凑牌', '每轮下注有固定上限', '打法偏稳健', '波动较低'],
    forceCombination: 'free',
    maxPlayers: 10,
  },
  [GameVariant.TEXAS_PLO]: {
    id: GameVariant.TEXAS_PLO,
    name: '底池限注德州',
    icon: '🏊',
    category: 'texas_series',
    shortDesc: '2张底牌，底池限注',
    ...
    isPotLimit: true,
    isFixedLimit: false,
    specialRules: ['2张底牌，自由组合凑牌', '底池限注（最大下注=当前底池）', '下注规则介于无限注和限注之间'],
    forceCombination: 'free',
    maxPlayers: 10,
  },
  [GameVariant.SIX_PLUS]: {
    id: GameVariant.SIX_PLUS,
    name: '短牌',
    icon: '⚡',
    category: 'texas_series',
    ...
    communityCardCount: 5,
    boardCount: 1,
    deckRanks: [...SHORT_DECK_RANKS],
    handRankOrder: SHORT_DECK_HAND_RANK_ORDER,
    isPotLimit: false,
    isFixedLimit: false,
    specialRules: ['牌库仅36张（去掉2-5）', '同花 > 葫芦（区别于标准德州）', 'A可当5组成A-6-7-8-9最小顺子', '无限制下注'],
    forceCombination: 'free',
    maxPlayers: 10,
  },
  [GameVariant.PINEAPPLE]: {
    id: GameVariant.PINEAPPLE,
    name: '大菠萝',
    icon: '🍍',
    category: 'texas_series',
    ...
    isPotLimit: false,
    isFixedLimit: false,
    specialRules: ['发3张底牌', '翻牌前必须弃掉1张底牌', '剩余2张按常规德州规则', '无限制下注'],
    forceCombination: 'free',
    maxPlayers: 10,
  },
  [GameVariant.CRAZY_PINEAPPLE]: {
    id: GameVariant.CRAZY_PINEAPPLE,
    name: '疯狂菠萝',
    icon: '🤪',
    category: 'texas_series',
    shortDesc: '3张底牌，3+2自由凑牌',
    fullDesc: '疯狂菠萝（Crazy Pineapple），发3张底牌，全程保留3张。从3张底牌+5张公共牌中自由组合凑出最佳5张牌型。牌力普遍偏高，成牌概率大。',
    holeCardCount: 3,
    communityCardCount: 5,
    boardCount: 1,
    deckRanks: [...RANKS],
    ...
    isPotLimit: false,
    isFixedLimit: false,
    specialRules: ['发3张底牌，全程保留', '从3张底牌+5张公共牌自由组合最佳5张', '牌力普遍偏高', '无限制下注'],
    forceCombination: 'free',
    maxPlayers: 10,
  },
  [GameVariant.TEXAS_DOUBLE_BOARD]: {
    id: GameVariant.TEXAS_DOUBLE_BOARD,
    name: '双排面德州',
    icon: '🎴',
    category: 'texas_series',
    ...
    isPotLimit: false,
    isFixedLimit: false,
    specialRules: ['两套板面独立发牌、独立比牌', '底池平分（A板50%+B板50%）', '自由组合凑牌', '无限制下注'],
    forceCombination: 'free',
    maxPlayers: 10,
  },
  [GameVariant.OMAHA_PLO]: {
    id: GameVariant.OMAHA_PLO,
    name: '奥马哈',
    icon: '🎪',
    category: 'omaha_series',
    ...
    isPotLimit: true,
    isFixedLimit: false,
    specialRules: ['4张底牌', '强制2张底牌+3张公共牌凑牌', '底池限注（最大下注=当前底池）', '不可多拿或少拿底牌'],
    forceCombination: '2+3',
    maxPlayers: 10,
  },
  [GameVariant.OMAHA_HI_LO]: {
    id: GameVariant.OMAHA_HI_LO,
    name: '奥马哈高低',
    icon: '↕️',
    category: 'omaha_series',
    ...
    isPotLimit: true,
    isFixedLimit: false,
    specialRules: ['4张底牌，强制2+3凑牌', '底池平分：高池50%+低池50%', '低池要求：牌点≤8且无顺子同花', '不满足低池条件则全归高池', '底池限注'],
    forceCombination: '2+3',
    maxPlayers: 10,
  },
  [GameVariant.OMAHA_PLO5]: {
    id: GameVariant.OMAHA_PLO5,
    name: '五张奥马哈',
    icon: '🖐️',
    category: 'omaha_series',
    ...
    isPotLimit: true,
    isFixedLimit: false,
    specialRules: ['5张底牌，强制2+3凑牌', '比常规PLO多一张起手牌', '底池限注', '组合更多波动更高'],
    forceCombination: '2+3',
    maxPlayers: 10,
  },
  [GameVariant.OMAHA_PLO6]: {
    id: GameVariant.OMAHA_PLO6,
    name: '六张奥马哈',
    icon: '🎲',
    category: 'omaha_series',
    ...
    isPotLimit: true,
    isFixedLimit: false,
    specialRules: ['6张底牌，强制2+3凑牌', '起手牌选择极多', '底池限注', '波动极高'],
    forceCombination: '2+3',
    maxPlayers: 10,
  },
  [GameVariant.OMAHA_DOUBLE_BOARD]: {
    id: GameVariant.OMAHA_DOUBLE_BOARD,
    name: '双排面奥马哈',
    icon: '🎯',
    category: 'omaha_series',
    ...
    isPotLimit: true,
    isFixedLimit: false,
    specialRules: ['4张底牌，强制2+3凑牌', '两套板面独立发牌、独立比牌', '底池平分（A板50%+B板50%）', '底池限注'],
    forceCombination: '2+3',
    maxPlayers: 10,
  },
  [GameVariant.OMAHA_THREE_BOARD]: {
    id: GameVariant.OMAHA_THREE_BOARD,
    name: '三板面奥马哈',
    icon: '🎯',
    category: 'omaha_series',
    ...
    isPotLimit: true,
    isFixedLimit: false,
    specialRules: ['4张底牌，强制2+3凑牌', '三套板面独立发牌、独立比牌', '底池分三份（每板面1/3）', '底池限注'],
    forceCombination: '2+3',
    maxPlayers: 10,
  },
  [GameVariant.FIVE_CARD_DRAW]: {
    id: GameVariant.FIVE_CARD_DRAW,
    name: '五张换牌',
    icon: '🔄',
    category: 'stud_draw_series',
    ...
    isPotLimit: false,
    isFixedLimit: false,
    specialRules: ['5张手牌，无公共牌', '可更换0-5张手牌', '换牌后直接摊牌比大小', '无翻牌/转牌/河牌轮次'],
    forceCombination: 'free',
    maxPlayers: 6,
  },
  [GameVariant.SEVEN_CARD_STUD]: {
    id: GameVariant.SEVEN_CARD_STUD,
    name: '七张梭哈',
    icon: '🃏',
    category: 'stud_draw_series',
    ...
    isPotLimit: false,
    isFixedLimit: false,
    specialRules: ['7张手牌（4明3暗）', '逐张发放、逐轮下注', '无公共牌', '需根据对手明牌判断实力'],
    forceCombination: 'free',
    maxPlayers: 8,
  },
  [GameVariant.SQUID_HOLDEM]: {
    id: GameVariant.SQUID_HOLDEM,
    name: '鱿鱼扣牌德州',
    icon: '🦑',
    category: 'squid_game_series',
    ...
    isPotLimit: false,
    isFixedLimit: false,
    specialRules: ['仅支持2人桌（1v1对抗）', '无大小盲，强制缴纳等额初始底池', '翻牌前可选择扣牌（隐藏1张底牌）', '扣牌后本轮下注需加倍', '河牌后未扣牌玩家先摊牌', '平局时重新发牌（无平局规则）', '输家扣除底池50%筹码'],
    forceCombination: 'free',
    maxPlayers: 2,
  },
  [GameVariant.SQUID_DALGONA_SUIT]: {
    id: GameVariant.SQUID_DALGONA_SUIT,
    name: '椪糖花色局',
    icon: '🍬',
    category: 'squid_game_series',
    ...
    isPotLimit: false,
    isFixedLimit: false,
    specialRules: ['开局随机指定目标花色', '凑牌需包含至少1张目标花色', '无效牌型直接判弃牌', '全员无效则底池归庄家', '有效牌型额外奖励10%底池', '翻牌后显示目标花色数量'],
    forceCombination: 'free',
    maxPlayers: 6,
  },
  [GameVariant.SQUID_GLASS_BRIDGE]: {
    id: GameVariant.SQUID_GLASS_BRIDGE,
    name: '玻璃桥比牌局',
    icon: '🌉',
    category: 'squid_game_series',
    ...
    isPotLimit: false,
    isFixedLimit: false,
    specialRules: ['3轮发牌（翻牌1张→转牌2张→河牌2张）', '每轮选择前进（下注）或后退（弃牌）', '过桥费递增：10%→20%→30%', '后退即弃牌，不参与后续轮次', '超时自动判后退', '坚持到最后且牌型最大者全拿'],
    forceCombination: 'free',
    maxPlayers: 8,
  },
};
